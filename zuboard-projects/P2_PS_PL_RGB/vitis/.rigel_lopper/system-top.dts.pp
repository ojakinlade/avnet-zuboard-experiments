#line 1 "../ps_pl_rgb_platform/hw/sdt/system-top.dts"
/dts-v1/;
#line 1 "../ps_pl_rgb_platform/hw/sdt/zynqmp.dtsi"
 ...
 */
#line 1 "../ps_pl_rgb_platform/hw/sdt/include/dt-bindings/dma/xlnx-zynqmp-dpdma.h"
/* SPDX-License-Identifier: (GPL-2.0 OR MIT) */
/*
 * Copyright 2019 Laurent Pinchart <laurent.pinchart@ideasonboard.com>
 */
#line 1 "../ps_pl_rgb_platform/hw/sdt/include/dt-bindings/gpio/gpio.h"
/* SPDX-License-Identifier: GPL-2.0 */
/*
...
#line 1 "../ps_pl_rgb_platform/hw/sdt/include/dt-bindings/interrupt-controller/arm-gic.h"
/* SPDX-License-Identifier: GPL-2.0 OR MIT */
/*
 * This header provides constants for the ARM GIC.
 */
#line 1 "../ps_pl_rgb_platform/hw/sdt/include/dt-bindings/interrupt-controller/irq.h"
/*
 ...
 * defined in this header.
 */
#line 11 "../ps_pl_rgb_platform/hw/sdt/include/dt-bindings/interrupt-controller/arm-gic.h"
 ...
 */
#line 1 "../ps_pl_rgb_platform/hw/sdt/include/dt-bindings/power/xlnx-zynqmp-power.h"
/* SPDX-License-Identifier: GPL-2.0 */
/*
 *  Copyright (C) 2018 Xilinx-2022 Xilinx, Inc.
 * (C) Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved.
 */
#line 1 "../ps_pl_rgb_platform/hw/sdt/include/dt-bindings/reset/xlnx-zynqmp-resets.h"
/* SPDX-License-Identifier: GPL-2.0 */
/*
 *  Copyright (C) 2018 Xilinx-2022 Xilinx, Inc.
 * (C) Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved.
 */
#line 22 "../ps_pl_rgb_platform/hw/sdt/zynqmp.dtsi"
/ {
...
#line 1 "../ps_pl_rgb_platform/hw/sdt/zynqmp-clk-ccf.dtsi"
// SPDX-License-Identifier: GPL-2.0+
/*
 ...
 * Michal Simek <michal.simek@amd.com>
 */
#line 1 "../ps_pl_rgb_platform/hw/sdt/include/dt-bindings/clock/xlnx-zynqmp-clk.h"
/* SPDX-License-Identifier: GPL-2.0 */
/*
 ...
 *
 */
#line 12 "../ps_pl_rgb_platform/hw/sdt/zynqmp-clk-ccf.dtsi"
/ {
...
#line 1 "../ps_pl_rgb_platform/hw/sdt/pl.dtsi"
/ {
	amba_pl: amba_pl {
		ranges;
		compatible = "simple-bus";
		#address-cells = <2>;
		#size-cells = <2>;
		firmware-name = "rgb_bd_wrapper.bit.bin";
		clocking0: clocking0 {
...
#line 1 "../ps_pl_rgb_platform/hw/sdt/pcw.dtsi"
	&psu_cortexa53_0 {
		xlnx,psu-ep = <1>;
		xlnx,rable = <0>;
	...
	&amba {
		...
		psu_r5_ddr_0: psu_ddr@100000 {
			...
			reg = <0x0 0x100000 0x0 0x3fe00000>;
		...
		psu_ddr_0: psu_ddr@0 {
			...
			xlnx,ddrc-act-freq-hz = <533333313>;
			reg = <0x0 0x0 0x0 0x3ff00000 0x0 0x3ff00000 0x0 0x100000>;
	...
	&psu_pmu_0 {
		...
		microblaze_ddr_reserve_sa = <0x3ff00000>;
		xlnx,use-dcache = <0>;
		xlnx,use-barrel = <1>;
		xlnx,allow-dcache-wr = <1>;
		microblaze_ddr_reserve_ea = <0x3fffffff>;
		...
		xlnx,ddr-reserve-sa = <0x3ff00000>;
		xlnx,lockstep-slave = <0>;
		xlnx,ddr-reserve-ea = <0x3fffffff>;
	...
	&mc {
		...
		xlnx,ddrc-clk-freq-hz = <266666656>;
		xlnx,qos-enable = <0>;
	...
	&qspi {
		...
		num-cs = <1>;
		xlnx,tz-nonsecure = <1>;
		xlnx,qspi-clk-freq-hz = <300000000>;
		xlnx,rable = <0>;
		xlnx,bus-width = <2>;
	...
	&spi0 {
		...
		xlnx,has-ss1 = <0>;
		num-cs = <1>;
		xlnx,spi-clk-freq-hz = <187500000>;
		xlnx,has-ss2 = <0>;
		xlnx,name = "psu_spi_0";
	};
	&i2c1 {
...
#line 6 "../ps_pl_rgb_platform/hw/sdt/system-top.dts"
/ {
	board = "zuboard_1cg";
	...
	psu_r5_ddr_0_memory: memory@100000 {
		...
		device_type = "memory";
		memory_type = "memory";
		reg = <0x0 0x100000 0x0 0x3FEFFFFF>;
	};
	...
	pmu {
		interrupt-affinity = <&psu_cortexa53_0>, <&psu_cortexa53_1>;
	};
	chosen {
	...
	cpus_a53: cpus-a53@0 {
		...
		address-map = <0x0 0xf0000000 &amba 0x0 0xf0000000 0x0 0x10000000>,
			      ...
			      <0x0 0xa0000000 &gpio_io_o 0x0 0xa0000000 0x0 0x10000>,
	...
	cpus_r5_0: cpus-r5@0 {
		...
		address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
			      ...
			      <0x100000 &psu_r5_ddr_0_memory 0x100000 0x3FEFFFFF>,
			      <0xa0000000 &gpio_io_o 0xa0000000 0x10000>,
			      ...
			      <0xff0d0000 &gem2 0xff0d0000 0x10000>,
	...
	cpus_microblaze_0: cpus_microblaze@0 {
		...
		address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
			      ...
			      <0x0 &psu_ddr_0_memory 0x0 0x3FF00000>,
			      <0x3FF00000 &psu_ddr_0_memory 0x3FF00000 0x100000>,
			      <0xa0000000 &gpio_io_o 0xa0000000 0x10000>,
			      <0xffa80000 &lpd_dma_chan1 0xffa80000 0x10000>,
			      <0xffa90000 &lpd_dma_chan2 0xffa90000 0x10000>,
			      <0xffaa0000 &lpd_dma_chan3 0xffaa0000 0x10000>,

...
synth_design -top blink_bd_wrapper -part xczu1cg-sbva484-1-e
...
write_checkpoint -force -noxdef blink_bd_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file blink_bd_wrapper_utilization_synth.rpt -pb blink_bd_wrapper_utilization_synth.pb"  } 
